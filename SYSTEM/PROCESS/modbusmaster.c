...
void modbus_slave_deal(uint8_t data, uint8_t addr)
{
    ...
    else
    {
        if (cnt > 2)
        {
            if (rxbuf[1] == 0x10) // 01 10 00 00 00 01 02 00 01 69 50 ��վ ������ �Ĵ�����ַ �Ĵ������� �ֽ��� �����д������ У��
            {
                len = (rxbuf[6] + 8);
                if (cnt > len)
                {
            ...
            else if (rxbuf[1] == 0x03 || rxbuf[1] == 0x06) // 01 03 00 00 00 01 84 0A ��վ ������ �Ĵ�����ַ �Ĵ�������/д�����ֵ У��
            {
                len = 7;
                if (cnt > len)
                {
...
void modbus_03_slave(uint16_t *buf) // 01 03 02 00 01 84 0A ��վ ������ �Ĵ������� �Ĵ������������ У��
{
...
void modbus_06_slave(uint16_t *buf) // 01 06 00 00 00 01 84 0A  ԭ������
{
...
void modbus_10_slave(uint16_t *buf) // 01 10 00 00 00 01 69 50 ��վ ������ �Ĵ����ĵ�ַ �Ĵ��������� У��
{
    uint8_t i, j;
    uint16_t len = 6;
